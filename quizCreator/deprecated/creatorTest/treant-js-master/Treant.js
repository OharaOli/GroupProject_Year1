...
;( function() {
    ...
    var TreeStore = {
        ...
        createTree: function( jsonConfig ) {
            //alert("create Tree begin")
            //alert(jsonConfig)
            var nNewTreeId = this.store.length;
            //alert("getiing the new TreeId complete")
            //alert(nNewTreeId)
            //alert(JSON.stringify(this))
            this.store.push( new Tree( jsonConfig, nNewTreeId ) );
            //alert("pushing new tree complete")
    ...
    var Tree = function (jsonConfig, treeId ) {
        ...
        this.reset = function( jsonConfig, treeId ) {
            ...
            ////////alert("treeId is: " + treeId)
            this.id = treeId;
            //alert("definition of Tree.reset")
            ////alert(JSON.stringify(jsonConfig.chart))
            this.CONFIG = UTIL.extend( Tree.CONFIG, jsonConfig.chart );
            ////alert("reset chart check")
            this.drawArea = UTIL.findEl( this.CONFIG.container, true );
            ////alert("this.drawArea complete")
            if ( !this.drawArea ) {
                ////alert('Failed to find element by selector "'+this.CONFIG.container+'"')
                throw new Error( 'Failed to find element by selector "'+this.CONFIG.container+'"' );
            }
            ////alert("this.drawArea contains:")
            ////////alert("reset middlePoint")
            UTIL.addClass( this.drawArea, 'Treant' );
            ////alert("addClass complete")
            ...
            ////alert('reset nodeStructure check')
            ...
            ////alert(" Tree reset function definition done")
            return this;
        };
    ...
    TreeNode.prototype = {
         ...
         */
        Tree: function() {
          ////alert("Tree constructor function begin")
            return TreeStore.get( this.treeId );
        },
    ...
    var Treant = function( jsonConfig, callback, jQuery ) {
        ...
        if ( jsonConfig instanceof Array ) {
            ...
            ////alert("creation of JSON config complete")
        }
        ...
        ////alert("create tree success")
        this.tree.positionTree( callback );
        ////alert("position tree success")
    };
    ...
    ////alert("exposing constructor success")
