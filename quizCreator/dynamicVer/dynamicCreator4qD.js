...
function addQuestionRow(givenTable) {
  ...
  //Commented Eu-bins code that creates an addAnswer & deleteAnswer buttons
  //to have by default 4 answer fields when a question row is added
  //sorry Eu-bin my man nothing personal brilliant code mate
/*
  ...
  elementAddAnswerButton.setAttribute('onclick', "addAnswerRow('answersTableQ"
                    + (lastRowIndex - 1) + "', '" + (lastRowIndex - 1) + "')");
  ...
  elementDeleteAnswerButton.setAttribute('onclick', "deleteQuestionRow('answersTableQ"
                    + (lastRowIndex - 1) + "')");
